<div class="main_search relative mt-3 md:mt-0">
    <input wire:model.debounce.500ms ="search"  class="flex bg-gray-900 rounded-full  px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Поиск">
